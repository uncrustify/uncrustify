 ...
 *  + non-case label indentation
 *  + if-else-for-while non-braced body indentation
 *
 */
...
//  */
// void reindent_text(BOOL indent)
// {
//    chunk_t          *pc;
//    chunk_t          *next;
//    chunk_t          *prev = NULL;
...
//             frm.level--;
//             frm.pse_tos--;
//             //            fprintf(stderr, "%3d] CLOSE(5) on %s, tos=%d\n", pc->orig_line,
//             //                    c_chunk_names[pc->type], pse_tos);
//          }
//       }
...
//       if (did_newline && (pc->type != CT_NEWLINE) && (pc->type != CT_NL_CONT))
//       {
//          if ((pc->type == CT_WORD) &&
//              ((pc->flags & PCF_VAR_DEF) != 0) &&
//              (prev != NULL) && (prev->type == CT_COMMA))
//          {
//             //             fprintf(stderr, "Vardefcol = %d\n", vardefcol);
//             if (indent)
//             {
...
//          {
//             //             fprintf(stderr, "stringcol = %d\n", last_str_col);
//             if (indent)
//             {
//                reindent_line(pc, last_str_col);
//             }
//          }
//          else if (((pc->type == CT_COMMENT_CPP) || (pc->type == CT_COMMENT)) &&
//                   (last_cpp_col > 0) && (pc->column > 1))
//          {
//             //reindent_line(pc, last_cpp_col);
//             pc->orig_col = pc->column; /*FIXME: comment hack */
//          }
//          else if (pc->type == CT_PREPROC)
//          {
//             //             fprintf(stderr, "preproc indent\n");
//             if (indent)
//             {
//                reindent_line(pc, 1);
//             }
...
//             //                     __func__, pc->orig_line, pse[pse_tos].indent_tmp);
//             if (indent)
//             {
...
//          frm.pse_tos++;
//          frm.pse[frm.pse_tos].type       = pc->type;
//          //pse[pse_tos].indent     = 1 + (level * tabsize);
//          frm.pse[frm.pse_tos].indent     = frm.pse[frm.pse_tos - 1].indent + tabsize;
//          frm.pse[frm.pse_tos].indent_tmp = frm.pse[frm.pse_tos].indent;
//          frm.pse[frm.pse_tos].open_line  = pc->orig_line;
//          frm.pse[frm.pse_tos].ref        = ++ref;
//          //         fprintf(stderr, "%3d] OPEN(7) on %s, tos=%d\n", pc->orig_line,
//          //                 c_chunk_names[pc->type], pse_tos);
//       }
//       else if (pc->type == CT_BRACE_OPEN)
//       {
...
//          frm.pse[frm.pse_tos].type = pc->type;
//          frm.pse[frm.pse_tos].ref  = ++ref;
//          //         fprintf(stderr, "%3d] OPEN(8) on %s, tos=%d\n", pc->orig_line,
//          //                 c_chunk_names[pc->type], pse_tos);
//
...
//          //                  pc->orig_line, pse[pse_tos].ref,
//          //                  get_token_name(pc->type), pse_tos, pse[pse_tos].indent);
//       }
...
//    {
//       fprintf(stderr, "Unmatched %s near line %d\n",
