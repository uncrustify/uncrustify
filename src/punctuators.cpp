...
/**
 *
 *   The file "punctuators.h" was generated from punc.py
 *   If you change one of the below symbol tables, re-run punc.py.
 *   $ python punc.py > src/punctuators.h
 *
 */
...
//const chunk_tag_t *find_punctuator_old(const char *str, UINT8 lang_flags)
//{
//   int i;
//
