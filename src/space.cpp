...
static iarf_e do_space(chunk_t *first, chunk_t *second, int &min_sp)
{
   ...
   if (  chunk_is_token(first, CT_AMP)
   ...
   // TODO: if necessary create a new option
   if (  chunk_is_token(first, CT_ENUM)
      && chunk_is_token(second, CT_ENUM_CLASS))
   {
      log_rule("ADD");
      return(IARF_ADD);
   }
   ...
   // TODO: if necessary create a new option
   if (  chunk_is_token(first, CT_ENUM_CLASS)
      && chunk_is_token(second, CT_TYPE))
   {
      log_rule("ADD");
      return(IARF_ADD);
   ...
   // TODO: if necessary create a new option
   if (  chunk_is_token(first, CT_FRIEND)
      && chunk_is_token(second, CT_CLASS))
   {
      log_rule("ADD");
      return(IARF_ADD);
   }
   ...
   // TODO: if necessary create a new option
   if (  chunk_is_token(first, CT_NAMESPACE)
      && chunk_is_token(second, CT_TYPE))
   {
      log_rule("ADD");
      return(IARF_ADD);
   ...
   if (  chunk_is_token(first, CT_PP_DEFINE)
      && chunk_is_token(second, CT_MACRO))
   {
      log_rule("ADD");
      return(IARF_ADD);
   }
   ...
   // TODO: if necessary create a new option
   if (  chunk_is_token(first, CT_PP_IF)
      && chunk_is_token(second, CT_PP_DEFINE))
   {
      log_rule("ADD");
      return(IARF_ADD);
   }
   ...
   // TODO: if necessary create a new option
   if (  chunk_is_token(first, CT_STRUCT)
      && chunk_is_token(second, CT_TYPE))
   {
      log_rule("ADD");
      return(IARF_ADD);
   ...
   // TODO: if necessary create a new option
   if (  chunk_is_token(first, CT_TYPEDEF)
      && chunk_is_token(second, CT_ENUM))
   {
      log_rule("ADD");
      return(IARF_ADD);
   }
   ...
   // TODO: if necessary create a new option
   if (  chunk_is_token(first, CT_TYPEDEF)
      && chunk_is_token(second, CT_STRUCT))
   {
      log_rule("ADD");
      return(IARF_ADD);
   }
   ...
   // TODO: if necessary create a new option
   if (  chunk_is_token(first, CT_USING)
      && chunk_is_token(second, CT_NAMESPACE))
   {
      log_rule("ADD");
      return(IARF_ADD);
   }
   ...
   // TODO: if necessary create a new option
   if (  chunk_is_token(first, CT_WORD)
      && chunk_is_token(second, CT_NUMBER_FP))
   {
      log_rule("ADD");
      return(IARF_ADD);
   }
