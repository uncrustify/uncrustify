 ...
 * but it's a whole another story when you look at their E_Token::PREPROC ('#') tokens!
 *
 * Hence we need to track and seek matching E_Token::PREPROC pp_levels here, which complicates
