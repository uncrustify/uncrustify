...
public:
    ...
    * @note: for E_Token::NEWLINE and E_Token::NL_CONT tokens, it also sets the chunk text
    */
   ...
   /**
    * @brief Returns the number of newlines in a E_Token::NEWLINE chunk
    */
   ...
   /**
    * @brief Sets the number of newlines in a E_Token::NEWLINE chunk
...
protected:
   ...
   E_Token         m_parentType;            //! type of the parent chunk usually E_Token::NONE
   ...
   size_t          m_nlCount;               //! number of newlines in E_Token::NEWLINE
...
{
   return(  Is(E_Token::COMMENT)
         || Is(E_Token::COMMENT_MULTI)
         || Is(E_Token::COMMENT_CPP));
}
...
{
   return(  Is(E_Token::SEMICOLON)
         || Is(E_Token::VSEMICOLON));
}
...
{
   return(  Is(E_Token::PAREN_OPEN)
         || Is(E_Token::FPAREN_OPEN)
         || Is(E_Token::LPAREN_OPEN)
         || Is(E_Token::PPAREN_OPEN)
         || Is(E_Token::RPAREN_OPEN)
...
{
   return(  Is(E_Token::PAREN_CLOSE)
         || Is(E_Token::FPAREN_CLOSE)
         || Is(E_Token::LPAREN_CLOSE)
         || Is(E_Token::PPAREN_CLOSE)
         || Is(E_Token::RPAREN_CLOSE)
...
{
   return(  Is(E_Token::ENUM)
         || Is(E_Token::ENUM_CLASS));
}


inline bool Chunk::IsClassOrStruct() const
{
   return(  Is(E_Token::CLASS)
         || Is(E_Token::STRUCT));
}
