...
private:
   /**
    * Analyzes all identifiers (marked as E_Token::WORD) between the starting and
    * ending chunks and changes E_Token::WORD to one of E_Token::TYPE, E_Token::MACRO_FUNC_CALL,
