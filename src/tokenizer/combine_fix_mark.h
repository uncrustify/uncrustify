...
/**
 * E_Token::CT_TYPE_CAST follows this pattern:
 * dynamic_cast<...>(...)
 *
 ...
 *  - FPAREN_OPEN (parent == E_Token::CT_FOR)
 *  - BRACE_OPEN
 *  - SEMICOLON
 */
 ...
 *
 * @param square_open points to a chunk of type E_Token::CT_SQUARE_OPEN, and the parent type is
 *                    assumed to have already been assigned the value E_Token::CT_CPP_LAMBDA;
 *                    under this assumption, the function marks all chunks as PCF_IN_LAMBDA
 *                    until the corresponding closing E_Token::CT_BRACE_CLOSE (with parent type
 *                    E_Token::CT_CPP_LAMBDA) is encountered
 */
 ...
 * Also mark any '*' encountered as a E_Token::CT_PTR_TYPE.
...
#endif /* TOKENIZER_COMBINE_FIX_MARK_H_INCLUDED */
