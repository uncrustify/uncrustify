...
EMSCRIPTEN_BINDINGS(MainModule)
{
   ...
   enum_<uncrustify_options>(STRINGIFY(uncrustify_options))
      ...
      .value(STRINGIFY(UO_sp_after_ptr_block_caret), UO_sp_after_ptr_block_caret)
      ...
      .value(STRINGIFY(UO_sp_before_square_asm_block), UO_sp_before_square_asm_block)
      .value(STRINGIFY(UO_sp_before_squares), UO_sp_before_squares)
      .value(STRINGIFY(UO_sp_cpp_before_struct_binding), UO_sp_cpp_before_struct_binding)
      .value(STRINGIFY(UO_sp_inside_square), UO_sp_inside_square)
      .value(STRINGIFY(UO_sp_inside_square_oc_array), UO_sp_inside_square_oc_array)
      ...
      .value(STRINGIFY(UO_sp_inside_braces_oc_dict), UO_sp_inside_braces_oc_dict)
      ...
      .value(STRINGIFY(UO_sp_fparen_brace_initializer), UO_sp_fparen_brace_initializer)
      ...
      .value(STRINGIFY(UO_sp_func_call_user_inside_fparen), UO_sp_func_call_user_inside_fparen)
      .value(STRINGIFY(UO_sp_func_call_user_paren_paren), UO_sp_func_call_user_paren_paren)
      ...
      .value(STRINGIFY(UO_sp_oc_catch_paren), UO_sp_oc_catch_paren)
      ...
      .value(STRINGIFY(UO_sp_oc_catch_brace), UO_sp_oc_catch_brace)
      .value(STRINGIFY(UO_sp_brace_catch), UO_sp_brace_catch)
      .value(STRINGIFY(UO_sp_oc_brace_catch), UO_sp_oc_brace_catch)
      ...
      .value(STRINGIFY(UO_sp_after_oc_synchronized), UO_sp_after_oc_synchronized)
      ...
      .value(STRINGIFY(UO_sp_after_noexcept), UO_sp_after_noexcept)
      ...
      .value(STRINGIFY(UO_indent_continue_class_head), UO_indent_continue_class_head)
      .value(STRINGIFY(UO_indent_single_newlines), UO_indent_single_newlines)
      ...
      .value(STRINGIFY(UO_indent_cs_delegate_body), UO_indent_cs_delegate_body)
      ...
      .value(STRINGIFY(UO_indent_member_single), UO_indent_member_single)
      ...
      .value(STRINGIFY(UO_indent_semicolon_for_paren), UO_indent_semicolon_for_paren)
      .value(STRINGIFY(UO_indent_first_bool_expr), UO_indent_first_bool_expr)
      .value(STRINGIFY(UO_indent_first_for_expr), UO_indent_first_for_expr)
      ...
      .value(STRINGIFY(UO_indent_align_paren), UO_indent_align_paren)
      ...
      .value(STRINGIFY(UO_indent_off_after_return_new), UO_indent_off_after_return_new)
      .value(STRINGIFY(UO_indent_single_after_return), UO_indent_single_after_return)
      .value(STRINGIFY(UO_indent_ignore_asm_block), UO_indent_ignore_asm_block)
      ...
      .value(STRINGIFY(UO_nl_cs_property_leave_one_liners), UO_nl_cs_property_leave_one_liners)
      ...
      .value(STRINGIFY(UO_nl_for_leave_one_liners), UO_nl_for_leave_one_liners)
      ...
      .value(STRINGIFY(UO_nl_oc_interface_brace), UO_nl_oc_interface_brace)
      .value(STRINGIFY(UO_nl_oc_implementation_brace), UO_nl_oc_implementation_brace)
      ...
      .value(STRINGIFY(UO_nl_tsquare_brace), UO_nl_tsquare_brace)
      ...
      .value(STRINGIFY(UO_nl_oc_catch_brace), UO_nl_oc_catch_brace)
      .value(STRINGIFY(UO_nl_brace_catch), UO_nl_brace_catch)
      .value(STRINGIFY(UO_nl_oc_brace_catch), UO_nl_oc_brace_catch)
      ...
      .value(STRINGIFY(UO_nl_squeeze_paren_close), UO_nl_squeeze_paren_close)
      ...
      .value(STRINGIFY(UO_nl_namespace_two_to_one_liner), UO_nl_namespace_two_to_one_liner)
      ...
      .value(STRINGIFY(UO_nl_create_func_def_one_liner), UO_nl_create_func_def_one_liner)
      ...
      .value(STRINGIFY(UO_nl_before_namespace), UO_nl_before_namespace)
      .value(STRINGIFY(UO_nl_after_namespace), UO_nl_after_namespace)
      ...
      .value(STRINGIFY(UO_align_same_func_call_params_span), UO_align_same_func_call_params_span)
      .value(STRINGIFY(UO_align_same_func_call_params_thresh), UO_align_same_func_call_params_thresh)
      ...
      .value(STRINGIFY(UO_indent_cpp_lambda_only_once), UO_indent_cpp_lambda_only_once)
   ...
   enum_<c_token_t>(STRINGIFY(c_token_t))
      ...
      .value(STRINGIFY(CT_WHERE_SPEC), CT_WHERE_SPEC)
      ...
      .value(STRINGIFY(CT_WHERE_COLON), CT_WHERE_COLON)
      ...
      .value(STRINGIFY(CT_OC_AVAILABLE), CT_OC_AVAILABLE)
      .value(STRINGIFY(CT_OC_AVAILABLE_VALUE), CT_OC_AVAILABLE_VALUE)
      .value(STRINGIFY(CT_CATCH), CT_CATCH)
      .value(STRINGIFY(CT_WHEN), CT_WHEN)
      .value(STRINGIFY(CT_WHERE), CT_WHERE)
      ...
      .value(STRINGIFY(CT_ACCESS), CT_ACCESS)
      .value(STRINGIFY(CT_ACCESS_COLON), CT_ACCESS_COLON)
      ...
      .value(STRINGIFY(CT_USING_ALIAS), CT_USING_ALIAS)
      ...
      .value(STRINGIFY(CT_FIXED), CT_FIXED)
      ...
      .value(STRINGIFY(CT_FUNC_START), CT_FUNC_START)
      ...
      .value(STRINGIFY(CT_DECLSPEC), CT_DECLSPEC)
      ...
      .value(STRINGIFY(CT_SQL_ASSIGN), CT_SQL_ASSIGN)
      ...
      .value(STRINGIFY(CT_CNG_HASINC), CT_CNG_HASINC)
      .value(STRINGIFY(CT_CNG_HASINCN), CT_CNG_HASINCN)
   ...
   enum_<lang_flag_e>(STRINGIFY(lang_flag_e))
      ...
      .value(STRINGIFY(FLAG_HDR), FLAG_HDR)
