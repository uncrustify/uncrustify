...
EMSCRIPTEN_BINDINGS( MainModule )
{
    ...
    // .value( STRINGIFY( UO_indent ), UO_indent )
    ...
    // .value( STRINGIFY( UO_indent_brace_struct ), UO_indent_brace_struct )
    // .value( STRINGIFY( UO_indent_paren ), UO_indent_paren )
    ...
    // .value( STRINGIFY( UO_ls_before_bool_op ), UO_ls_before_bool_op )
    // .value( STRINGIFY( UO_ls_before_paren ), UO_ls_before_paren )
    // .value( STRINGIFY( UO_ls_after_arith ), UO_ls_after_arith )
    // .value( STRINGIFY( UO_ls_honor_newlines ), UO_ls_honor_newlines )
    ...
    // .value( STRINGIFY( UO_align_pp_define_col_min ), UO_align_pp_define_col_min )
    // .value( STRINGIFY( UO_align_pp_define_col_max ), UO_align_pp_define_col_max )
    .value( STRINGIFY( UO_align_pp_define_gap ), UO_align_pp_define_gap )
    // .value( STRINGIFY( UO_align_enum_col_min ), UO_align_enum_col_min )
    // .value( STRINGIFY( UO_align_enum_col_max ), UO_align_enum_col_max )
    ...
    // .value( STRINGIFY( UO_align_struct_array_brace ), UO_align_struct_array_brace )
    ...
    // .value( STRINGIFY( UO_nl_after_func_class_def ), UO_nl_after_func_class_def )
    ...
    // .value( STRINGIFY( UO_nl_after_ifdef ), UO_nl_after_ifdef )
    ...
    value_object< option_map_value >( STRINGIFY( option_map_value ) )
    .field( STRINGIFY( id ), &option_map_value::id )
    .field( STRINGIFY( group_id ), &option_map_value::group_id )
    .field( STRINGIFY( type ), &option_map_value::type )
    .field( STRINGIFY( min_val ), &option_map_value::min_val )
    .field( STRINGIFY( max_val ), &option_map_value::max_val )
    .field( STRINGIFY( name ), &option_map_value::name )
