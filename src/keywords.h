 ...
 * other languages. They are tokenized as E_Token::CT_IN and E_Token::CT_OUT.
 * The correct tokenization is E_Token::CT_FUNC_VAR.
 *
 ...
 *
 * @return E_Token::CT_WORD (no match) or the keyword token
 */
 ...
 * @param type  The type, usually E_Token::CT_TYPE
 */
