...
const long const_int_long_var;
long const int long_const_int_var;
long int const long_int_const_var;
const long int_const_long_var;
long const int_long_const_var;
...
unsigned long int_unsigned_long_var;
long unsigned unsigned_long_int_var;
