...
long int long long_long_var;
long long int long_long_int_var;
long int long int_long_long_var;
...
unsigned int long unsigned_long_var;
int long unsigned long_unsigned_var;

unsigned const int long unsigned_const_long_var;
...
unsigned int long int_unsigned_long_var;
