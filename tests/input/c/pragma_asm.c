...
int main() { int a = 1; int very_long = 2; }
...
int main2() { int a = 1; int very_long = 2; }
...
int main3() { int a = 1; int very_long = 2; }
...
int main4() { int a = 1; int very_long = 2; }
...
int main5() { int a = 1; int very_long = 2; }
